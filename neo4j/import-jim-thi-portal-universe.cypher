...
SET g.title = "Jim x Thi Knowledge Portal", g.generatedAt = "2026-07-30", g.scopeNote = "Public-facing GitHub Pages portal for Jim and Thi, built from material actually shared between them.";

MERGE (n:JimThiPortalNode {uid: "jim-thi-knowledge-portal-v1:portal"})
SET n.id = "portal", n.name = "Jim x Thi Portal", n.type = "portal", n.cluster = "Portal spine", n.status = "public-v1", n.summary = "Public GitHub Pages cockpit for shared summaries, artifacts, and topic clusters.", n.detail = "The portal grows from actual Jim/Thi work and keeps the shared source material connected to useful summaries.", n.url = "", n.graphKey = "jim-thi-knowledge-portal-v1";
...
SET n.id = "artifact_emperor", n.name = "The Emperor", n.type = "artifact", n.cluster = "Books", n.status = "new", n.summary = "Tarot archetype of authority, structure, stability, boundaries, and disciplined leadership.", n.detail = "Jim shared Biddy Tarot's interpretation of the fourth Major Arcana card: a figure of order, protection, disciplined authority and the structures that make stability possible.", n.url = "https://biddytarot.com/tarot-card-meanings/major-arcana/emperor/", n.graphKey = "jim-thi-knowledge-portal-v1";
...
SET n.id = "artifact_circle", n.name = "The Circle", n.type = "artifact", n.cluster = "Books", n.status = "new", n.summary = "Dave Eggers' 2013 dystopian novel about a dominant technology company whose pursuit of transparency erodes privacy, autonomy, and dissent.", n.detail = "Mae Holland joins the Circle, a powerful technology company combining search, social identity, payments and surveillance. What begins as convenience and belonging gradually becomes a system in which visibility is treated as virtue and privacy as guilt.", n.url = "https://en.wikipedia.org/wiki/The_Circle_(Eggers_novel)", n.graphKey = "jim-thi-knowledge-portal-v1";
...
SET n.id = "artifact_on_bullshit", n.name = "On Bullshit", n.type = "artifact", n.cluster = "Books", n.status = "new", n.summary = "Harry Frankfurt's philosophical essay distinguishing bullshit from lying: the liar tracks truth in order to conceal it; the bullshitter is indifferent to truth.", n.detail = "Harry Frankfurt’s short philosophical essay argues that bullshit is not simply falsehood. A liar must respect the truth enough to hide it; the bullshitter is focused instead on producing an impression and is indifferent to whether the claim is true.", n.url = "https://www.csc2.ncsu.edu/faculty/mpsingh/local/Social/f24/wrap/readings/Harry-Frankfurt-On-Bullshit-1988.pdf", n.graphKey = "jim-thi-knowledge-portal-v1";
...
SET n.id = "artifact_human_stupidity", n.name = "The Basic Laws of Human Stupidity", n.type = "artifact", n.cluster = "Books", n.status = "new", n.summary = "Carlo M. Cipolla's satirical model of stupidity: people routinely underestimate its prevalence and destructive power, especially when actions harm others without benefiting the actor.", n.detail = "Carlo M. Cipolla presents five mock-serious laws and a two-axis model of human behaviour. The dangerous category is the stupid person: someone whose action creates losses for others while producing no gain—and often a loss—for themselves.", n.url = "https://ia801609.us.archive.org/29/items/kaufman-s-clinical-neurology-for-psychiatrists-pdfdrive/The%20Basic%20Laws%20of%20Human%20Stupidity%20%28Carlo%20M.%20Cipolla%29%20%28Z-Library%29.pdf", n.graphKey = "jim-thi-knowledge-portal-v1";
...
SET n.id = "artifact_flying_machines", n.name = "Those Magnificent Men in Their Flying Machines", n.type = "artifact", n.cluster = "Books", n.status = "new", n.summary = "The 1965 British adventure comedy about an eccentric international air race from London to Paris in the pioneering era of aviation.", n.detail = "Set in 1910, the film follows an eccentric international field of aviators competing in a London-to-Paris air race. Their fragile machines, rivalries, romances and national stereotypes turn technological progress into elaborate comic chaos.", n.url = "https://ok.ru/video/6496174017084", n.graphKey = "jim-thi-knowledge-portal-v1";
...
SET r.graphKey = "jim-thi-knowledge-portal-v1", r.strength = "strong", r.note = "Shared books, essays, films, and references.";
...
MATCH (a:JimThiPortalNode {uid: "jim-thi-knowledge-portal-v1:stream_whatsapp"}), (b:JimThiPortalNode {uid: "jim-thi-knowledge-portal-v1:pill_books"})
MERGE (a)-[r:HAS_SOURCE_STREAM {uid: "jim-thi-knowledge-portal-v1:edge:e_chat_to_books"}]->(b)
SET r.graphKey = "jim-thi-knowledge-portal-v1", r.strength = "medium", r.note = "Shared references can originate in the Jim–Thi conversation.";
